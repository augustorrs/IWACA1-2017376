...
router.get('/get/html', function(req, res) {
  ...
  var xml = fs.readFileSync('PisaItalianRestaurant.xml', 'utf8'); //We are reading in the XML file
  var xsl = fs.readFileSync('PisaItalianRestaurant.xsl', 'utf8'); //We are reading in the XSL file
...
router.post('/post/json', function(req, res) {
  ...
  function appendJSON(obj) {
    ...
    xmlFileToJs('PisaItalianRestaurant.xml', function(err, result) {
      if (err) throw (err);
      ...
      result.cafemenu.section[obj.sec_n].entree.push({'item': obj.item,'desc':obj.desc, 'price': obj.price}); //If your XML elements are differet, this is where you have to change to your own element names
      //Converting back to our original XML file from JSON
      jsToXmlFile('PisaItalianRestaurant.xml', result, function(err) {
...
router.post('/post/delete', function(req, res) {
  ...
  function deleteJSON(obj) {
    ...
    xmlFileToJs('PisaItalianRestaurant.xml', function(err, result) {
	 ...
	 // console.log(obj.section + "  ||   " + obj.entree);
	 // console.log(result.cafemenu.section[obj.section].entree[obj.entree]);
